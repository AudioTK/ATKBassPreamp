...
//==============================================================================
const juce::String ATKBassPreampAudioProcessor::getName() const
{
...
bool ATKBassPreampAudioProcessor::isMidiEffect() const
{
#if JucePlugin_IsMidiEffect
  return true;
#else
...
const juce::String ATKBassPreampAudioProcessor::getProgramName(int index)
{
  return {};
}

void ATKBassPreampAudioProcessor::changeProgramName(int index, const juce::String& newName)
{
}
...
void ATKBassPreampAudioProcessor::processBlock(juce::AudioSampleBuffer& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* ATKBassPreampAudioProcessor::createEditor()
{
  return new ATKBassPreampAudioProcessorEditor(*this, parameters);
}

//==============================================================================
void ATKBassPreampAudioProcessor::getStateInformation(juce::MemoryBlock& destData)
{
